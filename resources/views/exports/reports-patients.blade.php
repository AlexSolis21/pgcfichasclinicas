  ...
  <div class="row">
    <div class="col-xs-4">
      <div class="invoice-logo-container">
        <img class="invoice-logo" src="{{ public_path('assets/img/descarga.jpg') }}">
      </div>
    </div>
    <div class="col-xs-8">
      <h1 class="font-weight-bold">
        Sistema de fichas clinicas
      </h1>
      <div class="text-company">
        <div class="font-weight-bold fs-18">
          Reporte de pacientes
        </div>
        <div class="fs-16">Generado el: {{\Carbon\Carbon::now('GMT-6')->format('d M Y')}}</div>
        <div class="fs-16"></div>
      </div>
    </div>
  </div>
    ...
    <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
      <tr>
        ...
        <td width="60%" class="text-center">
          <span>San Cristobal Totonicapán</span>
        </td>
