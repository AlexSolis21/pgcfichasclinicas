<div class="container my-auto mt-5">
    <div class="row signin-margin">
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <img src="{{ asset('assets') }}/img/logoumg.png"
                style="display: block; margin-left: auto; margin-right: auto; width: 50%; margin-bottom: 50px;">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent='store'>
                        ...
                        @endif
                        <div
                            class="input-group input-group-outline mt-3 @if (strlen($correo ?? '') > 0) is-filled @endif">
