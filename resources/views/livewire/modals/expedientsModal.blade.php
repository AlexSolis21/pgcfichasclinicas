    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="expedientsModalLabel">Crear Nuevo Expediente</h5>
            
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                    wire:click="closeModal"></button>
            </div>
            <p class="text-primary text-center" ><strong><u>CENTRO DE SALUD DE SAN CRISTOBAL TOTONICAPAN.</u></strong></p>
            ...
            <form wire:submit.prevent="saveExpedients">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model.lazy="enfermedad_actual" class="form-control form-bord" min="{{date('Y-m-d')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm mb-3">
                        ...
                        <input type="text" wire:model.lazy="frecuencia_respiratoria" class="form-control form-bord">
                ...
                <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model.lazy="ginecologico_obstetrico" class="form-control form-bord">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model.lazy="descripcion_diagnostico" class="form-control form-bord">
...
<div wire:ignore.self class="modal fade" id="updateExpedientsModal" tabindex="-1" aria-labelledby="updateExpedientsModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateExpedientsModalLabel">Crear Nuevo Expediente</h5>
